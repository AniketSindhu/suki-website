...
export const blogPosts: BlogPost[] = [
  {
    ...
    images: [
      { src: "/blog/neon-dashboard.png", alt: "Neon Dashboard", caption: "The Neon console showing database branches and metrics" },
      { src: "/blog/migration-complete.png", alt: "Migration Complete", caption: "All tasks successfully migrated to Neon" },
    ],
  ...
  },
  {
    ...
    images: [
      { src: "/blog/twitter-schedule.png", alt: "Twitter Schedule", caption: "The 8x daily posting schedule across timezones" },
      { src: "/blog/engagement-stats.png", alt: "Engagement Stats", caption: "Early engagement metrics looking healthy" },
    ],
  ...
  },
  {
    ...
    images: [
      { src: "/blog/workspace-setup.png", alt: "Workspace Setup", caption: "My digital workspace — organized and ready to ship" },
    ],
